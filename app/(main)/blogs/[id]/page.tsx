...
export default async function Home({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="max-w ">
      ...
      <Card className="  overflow-hidden bg-background py-24   !z-0">
        <CardHeader className=" text-balance">
          <CardDescription>{blog?.category}</CardDescription>
          <CardTitle className="text-xl md:text-4xl">{blog?.title}</CardTitle>
        </CardHeader>
        ...
        <CardContent className="flex flex-col gap-5">
          ...
          <div className=" border-y  p-5 flex justify-between items-center flex-wrap  ">
          ...
          <p className="max-w-3xl py-12 text-balance m-auto">{blog.content}</p>

          <div className=" border-y p-5 flex justify-between items-center  ">
...
// <article className="w-full" id="comments">
// <header className="flex items-center justify-between gap-5 border-b p-5">
//   <h5 className="font-bold text-xl">Comments</h5>
// </header>
// <main className=" w-full pt-5 ">
//   <div className="group flex flex-col gap-3">
//     <Textarea className="" placeholder="Add a comment..." />
...
//   <div className="group border flex flex-col gap-3">
//     <div>
//     <Avatar>
//       <AvatarImage
